    ...
    <Col xl={6} lg={6}>
      <div className="welcome-one__right">
        ...
        <p className="welcome-one__right-text">
          By working together and supporting one another, we have the power to
          improve the world around us. When people lend a hand, share resources,
          and show kindness, communities thrive and problems become easier to
          solve.
        </p>
        <div className="welcome-one__our-mission-and-story">
          <div className="welcome-one__mission-and-story-single">
            ...
            Empowering underprivileged communities through accessible education and holistic support programs.
            </p>
          </div>
          <div className="welcome-one__mission-and-story-single">
            <h3>
            ...
            <p className="welcome-one__our-mission-and-story-text">
            Helping hands join to uplift lives, one heartwarming story at a time.
            </p>
          </div>
        </div>
